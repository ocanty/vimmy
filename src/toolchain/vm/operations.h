...
VM_DEFINE_OPERATION_H(LOOP, 54)
VM_DEFINE_OPERATION_H(RAND, 55)
VM_DEFINE_OPERATION_H(STRCAT, 56)
VM_DEFINE_OPERATION_H(STRLEN, 57)
VM_DEFINE_OPERATION_H(STRCPY, 64)
VM_DEFINE_OPERATION_H(STRCMP, 65)
